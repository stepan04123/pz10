(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        createTodoApp(document.getElementById('todo'), 'Это моё');
        createTodoApp(document.getElementById('todomom'), 'Это мамы');
        createTodoApp(document.getElementById('tododad'), 'Это папы');
    });
}) ();